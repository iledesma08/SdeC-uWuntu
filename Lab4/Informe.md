...
# Desafío 1: Creación de Paquetes con Checkinstall
...
#### 1. Autenticación de módulos en RHEL 8 y sistemas con Secure Boot

Cuando se carga un módulo, en RHEL 8 se comprueba la firma del mismo con las claves públicas X.509 presentes en:
